...
import {A_starSearch, breadthFirstSearch, FifoQueue, MinPriorityQueue} from "./graphSearch.js";
...
describe("A* search", () => {
    ...
    it("Gets from A to B", () => {
        ...
        expect(bestRoute.cost).toStrictEqual(1);
    ...
    it("Takes cheaper route with more nodes", () => {
        ...
        const bestRoute = A_starSearch(graph, "A", "B");
        expect(bestRoute.cost).toStrictEqual(6);
    });
